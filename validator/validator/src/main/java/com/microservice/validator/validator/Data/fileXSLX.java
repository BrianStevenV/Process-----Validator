...
public class fileXSLX {
    ...
    public fileXSLX(String date, String injuryLocation, String gender, String ageGroup, String incidentType, String dayLost, String plant, String reportType, String shift, String department, String incidentCost, String wkDay, String month, String year) {
        this.date = date;
